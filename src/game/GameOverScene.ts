class GameOverScene extends egret.DisplayObjectContainer {
    ...
    public initScene() {
        ...
        this._gameOverText = GameUtil.createBitmapFromSheetByName("text_game_over")
        ...
        let menuButton = GameUtil.createBitmapFromSheetByName("button_menu")
        ...
        let okButton = GameUtil.createBitmapFromSheetByName("button_ok")
